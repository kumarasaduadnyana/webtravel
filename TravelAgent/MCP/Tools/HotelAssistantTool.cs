...
public class HotelAssistantTool(IHotelService hotelService)
{
    ...
    public async Task<SearchHotelResponse> SearchHotel(
        ...
        [Description("Number of children or infants")] int children = 2,
        ...
        [Description("The number of results per page.")] int pageSize = 40)
    {
        var hotels = await hotelService.SearchHotel(destination, checkIn, checkOut, adults, children, rooms, currency, sortBy, ratings, minPrice, maxPrice, minRating, amenities, pageSize);
